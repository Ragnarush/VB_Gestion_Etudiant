...
Public Class rapport_etuParProg
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "VB_P44_TP2_v2210043_v1.rapport_etuParProg.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrapport_etuParProg
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rapport_etuParProg = New rapport_etuParProg()
        rpt.Site = Me.Site
        Return rpt
    End Function
