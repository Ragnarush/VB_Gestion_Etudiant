...
Public Class rapport_programmes
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "VB_P44_TP2_v2210043_v1.rapport_programmes.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrapport_programmes
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rapport_programmes = New rapport_programmes()
        rpt.Site = Me.Site
        Return rpt
    End Function
